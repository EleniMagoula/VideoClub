namespace VideoClub.Infrastructure.Migrations
{
    ...
    public partial class BasicEntities : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DayOfBooking = c.DateTime(nullable: false),
                        ToBeReturned = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Bookings", "DVDId", "dbo.DVDs");
            ...
            DropIndex("dbo.Bookings", new[] { "DVDId" });
